  ...
  >
    <div :class="{ 'opacity-0': loading }">
      <template v-if="$slots.icon">
        <div
          class="flex items-center gap-[6px] justify-center"
          :class="{ 'flex-row-reverse': leftIcon }"
        >
          <slot name="icon" />
          <slot />
        </div>
...
.btn {
  @apply relative text-white min-w-fit  items-center justify-center flex   text-[0.9rem] px-6 py-2 rounded transition-all ease-in delay-50;
  border-width: 2px;
